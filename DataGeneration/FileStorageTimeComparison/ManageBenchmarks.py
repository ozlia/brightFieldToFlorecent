...
if __name__ == '__main__':  # Manage benchmarks - timing is conducted in seconds
    '''
    ...
    #if running in cluster : (this class is separate from utils)
    curr_user = getpass.getuser().split("@")[0]
    root_dir = f"/home/{curr_user}/TimingSaveMethods"
    makedirs(join(root_dir,'result','raw'),exist_ok=True)
    chdir(root_dir)
