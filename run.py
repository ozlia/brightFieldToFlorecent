...
from UNET.organizedUNET import SpecialUNet
# from UNET.SpecialUnetLiad import SpecialUNet
...
model = SpecialUNet(img_size_rev, epochs=epochs, batch_size=batch_size)
